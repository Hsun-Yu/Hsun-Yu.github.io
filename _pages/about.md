...
---
Hi, I'm Hsun-Yu (訓佑).
I am currently a master's student in Computer Science at École Polytechnique Fédérale de Lausanne (EPFL). My research interests lie in understanding why deep learning models can generalise to unseen, out-of-distribution tasks and how to make them more robust and generalisable. In particular, I am fascinated by using Causality to explore these questions.
...
🗞️ Recent News
======
- [06/2025] I’m excited to start my research internship with the Robust Machine Learning Group at the Max Planck Institute for Intelligent Systems, Tübingen, under the supervision of [Wieland Brendel](https://is.mpg.de/rml/person/wbrendel) and [Patrik Reizinger](https://is.mpg.de/rml/person/preizinger).
